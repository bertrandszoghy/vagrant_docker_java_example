(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('performers',{
	        url:'/performers',
	        templateUrl: viewsPrefix + 'performers.html',
	        controller:'PerformerListController'
	    }).state('viewPerformer',{
	       url:'/performers/:id/view',
	       templateUrl: viewsPrefix + 'performer-view.html',
	       controller:'PerformerViewController'
	    }).state('newPerformer',{
	        url:'/performers/new',
	        templateUrl: viewsPrefix + 'performer-add.html',
	        controller:'PerformerCreateController'
	    }).state('editPerformer',{
	        url:'/performers/:id/edit',
	        templateUrl: viewsPrefix + 'performer-edit.html',
